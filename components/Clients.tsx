...
const clients = [
  { name: "Brez", logo: "https://placehold.co/180x80/1a1a1a/C084FC?text=BREZ" },
  { name: "Whop", logo: "https://placehold.co/180x80/1a1a1a/C084FC?text=WHOP" },
  {
    name: "Punch",
    logo: "https://placehold.co/180x80/1a1a1a/C084FC?text=PUNCH",
  },
  {
    name: "Scarface",
    logo: "https://placehold.co/180x80/1a1a1a/C084FC?text=SCARFACE",
  },
  {
    name: "Fredo",
    logo: "https://placehold.co/180x80/1a1a1a/C084FC?text=FREDO",
  },
];
...
export default function Clients() {
  return (
    <section className="w-full py-20 bg-linear-to-b from-white/10 via-black via-50% to-black flex flex-col items-center justify-center overflow-hidden">
      {/* Marquee Container */}
        ...
        >
          {marqueeClients.map((client, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-purple-500/20 blur-xl rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none" />
            </div>
          ))}
        </motion.div>
      </div>
