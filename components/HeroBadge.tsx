...
export default function HeroBadge() {
  return (
    <div className="flex items-center justify-center gap-3 px-5 py-2 rounded-full border border-white/10 bg-white/5 backdrop-blur-md w-max mx-auto mt-28 md:mt-32 shadow-[0_0_15px_rgba(255,255,255,0.05)]">
      {/* Pulse Indicator */}
