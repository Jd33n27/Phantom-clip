...
const steps = [
  {
    stage: "Stage 1",
    title: "Build",
    description: "We create a private, dedicated clipping community for your brand. You simply send us your content (preferably organized in a Google Drive), and we take care of the rest, including onboarding clippers from both your audience and our network of thousands.",
  ...
  },
  {
    stage: "Stage 3",
    title: "Scale",
    description: "Our team actively manages your community daily, answering questions, building relationships, and keeping energy high. Every post submission is manually reviewed for quality before approval, ensuring only top-tier content is approved for payouts.",
...
export default function Process () {
  return (
    <section className="relative w-full py-32 bg-black flex flex-col items-center">
      ...
      {/*Header Section */}
      <div className="mb-24 text-center max-w-4xl px-6 relative z-10">
        <motion.div 
            ...
            <div className="flex-1 w-full pl-12 md:pl-0 md:px-12">
              <div className="group relative p-8 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm hover:bg-white/[0.07] transition-colors duration-500">
                ...
                <div className="flex flex-wrap gap-3 mb-6">
                  {step.tags.map(tag => (
                    <span key={tag} className="px-3 py-1.5 text-sm text-gray-300 bg-white/5 border border-white/10 rounded-lg">
                      {tag}
                    </span>
                  ))}
                </div>
