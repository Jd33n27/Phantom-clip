    ...
    <footer className="relative w-full bg-black pt-20 md:pt-32 pb-10 overflow-hidden">
     {/* CTA Section */}
      <div className="w-full max-w-360 mx-auto px-6 mb-24 md:mb-32 flex flex-col items-center text-center relative z-10">
        ...
        >
          Join the creators and brands generating billions of views with our
          automated clipping infrastructure.
        </motion.p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 mb-16">
            ...
            <div className="md:col-span-1 space-y-6">
              ...
              <p className="text-sm text-gray-400 leading-relaxed">
                We build mass content distribution systems for brands and
                creators.
              </p>
            </div>
            ...
            <div className="md:col-span-3 grid grid-cols-2 md:grid-cols-3 gap-8">
              ...
              <div className="flex flex-col gap-4">
                ...
                <a
                  href="mailto:hello@phantomclips.com"
                  className="text-gray-400 hover:text-yellow-500 transition-colors text-sm"
                >
                  Email Us
                </a>
